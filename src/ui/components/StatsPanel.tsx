      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {selectedOperation === 'summarize' && (
          <div className="bg-orange-50 rounded-lg p-3">
            ...
            <div className="text-lg font-bold text-orange-800">{stats.compressionRatio}%</div>
        ...
        {selectedOperation === 'expand' && (
          <div className="bg-indigo-50 rounded-lg p-3">
            ...
            <div className="text-lg font-bold text-indigo-800">{Math.round((stats.outputWordCount / stats.wordCount - 1) * 100)}%</div>
